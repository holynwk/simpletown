...
public class SimpleTownPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        blueMapService = new BlueMapService(this, townManager, warManager);
        ...
        TownAdminCommand adminCommand = new TownAdminCommand(this, townManager, messages, settingsMenuManager, richChunkService, blueMapService, politicalScoreService, warManager);
    ...
    private void registerPlaceholder() {
        if (getServer().getPluginManager().getPlugin("PlaceholderAPI") != null) {
            new TownPlaceholder(townManager).register();
