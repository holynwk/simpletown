...
public class TownAdminCommand implements CommandExecutor, TabCompleter {
    ...
    public TownAdminCommand(Plugin plugin, TownManager townManager, MessageService messages, SettingsMenuManager settingsMenuManager, RichChunkService richChunkService, BlueMapService blueMapService, PoliticalScoreService politicalScoreService, WarManager warManager) {
        this.plugin = plugin;
