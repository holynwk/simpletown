...
public class TownStorage {
    ...
    public List<Town> loadTowns() {
        ...
        for (String townName : config.getKeys(false)) {
            ...
            towns.add(new Town(townName, mayorName, citizens, chunks, capital, bank, open, citizenFlags, outsiderFlags, color, ageLevel, buildings, inventory, plots, spawn, createdAt));
        }
        return towns;
    }
